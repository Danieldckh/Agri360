...
router.patch('/:id', async (req, res) => {
  ...
  const fields = ['title', 'description', 'status', 'department', 'booked_date', 'due_date', 'campaign_month_start', 'campaign_month_end', 'form_data', 'sign_off_date', 'representative', 'decline_reason', 'editable_url', 'esign_url', 'checklist_url', 'proposal_file_url', 'proposal_file_name', 'proposal_file_mime', 'proposal_file_uploaded_at', 'assigned_admin', 'assigned_design', 'unsigned_file_url', 'signed_file_url', 'change_notes'];
  const updates = [];
  const values = [];
  let idx = 1;
